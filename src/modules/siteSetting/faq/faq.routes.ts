 ...
 */
router.post("/", /* requireAuth, */ createFaqHandler);
 ...
 *       "404": { description: "Not found" }
 */
router.put("/:id", /* requireAuth, */ updateFaqHandler);
 ...
 *       "404": { description: "Not found" }
 */
router.delete("/:id", /* requireAuth, */ deleteFaqHandler);
 ...
 */
router.patch("/:id/publish", /* requireAuth, */ publishFaqHandler);
