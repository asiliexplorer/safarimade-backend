...
const ctrl = __importStar(require("./package.controller"));
...
router.delete("/:id", authMiddleware_1.authMiddleware, (0, roleMiddleware_1.roleMiddleware)("admin"), ctrl.removePackage);
