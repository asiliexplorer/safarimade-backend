...
const TravelProposalSchema = new mongoose_1.Schema({
...
const TravelProposalModel = mongoose_1.default.models.TravelProposal ||
    mongoose_1.default.model("TravelProposal", TravelProposalSchema);
exports.default = TravelProposalModel;
